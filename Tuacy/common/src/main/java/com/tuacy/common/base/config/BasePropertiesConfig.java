package com.tuacy.common.base.config;

import android.content.Context;
import android.content.res.AssetManager;


import com.tuacy.common.base.properties.BaseProperties;
...
public abstract class BasePropertiesConfig implements BaseProperties {
	...
	private void initialize() {
		...
		try {
			...
			CustomLog.e(BasePropertiesConfig.class, e, "Cannot open: %s", getPropertyFileName());
		} finally {
			if (in != null) {
				try {
					in.close();
